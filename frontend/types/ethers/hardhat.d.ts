...
declare module "hardhat/types/runtime" {
    interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
        getContractFactory(name: "HabitSource", signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.HabitSource__factory>;
        getContractFactory(name: "HabitTracker", signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.HabitTracker__factory>;
